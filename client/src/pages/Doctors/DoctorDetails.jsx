            ...
            <div className="flex items-center gap-5">
              ...
              <div className="">
                ...
                <div className="flex items-center gap-[6px]">
                  ...
                  <span className="text-[14px] leading-5 lg:text-[16px] lg:leading-7 font-[400] text-textColor">(254)</span>
                </div>

                <p className="text__para text-[14px] leading-5 md:text-[15px] lg:max-w-[390px] mt-[18px] text-textColor">Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto inventore ad culpa, repudiandae ducimus labore.</p>
              </div>
            </div>
